            ...
            <div class="col-xs-6 col-xs-offset-3">
                ...
                <h1>Register</h1>
                    <form role="form" action="registration.php" method="post" id="login-form" autocomplete="off">
                        ...
                        <div class="form-group">
                            <label for="firstname" class="sr-only">Fristname</label>
                            <input type="text" name="user_firstname" id="user_firstname" class="form-control" placeholder="Enter Desired Fristname">
                        </div>
                        <div class="form-group">
